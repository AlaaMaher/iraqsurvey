...
public class CitiesSpinnerAdapter extends ArrayAdapter<String>{
    ...
    private final List<CitiesModels> items;
    private final int mResource;

    public CitiesSpinnerAdapter(@NonNull Context context, @LayoutRes int resource,
    ...
    private View createItemView(int position, View convertView, ViewGroup parent){
        ...
        if (items.size() != 0)
        {
            CitiesModels offerData = items.get(position);
